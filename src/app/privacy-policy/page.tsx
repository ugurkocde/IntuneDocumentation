      ...
      <main>
        <div className="container mx-auto max-w-3xl px-4 py-16">
          ...
          <section className="space-y-6 leading-relaxed text-slate-700">
            ...
            <ul className="list-disc space-y-2 pl-6">
              <li>
                your license key or, when your organization shares its license
                with your tenant, a Microsoft sign-in token (ID token) instead.
                We verify the token and use only its tenant ID. The token is
                not stored;
              </li>
              <li>
