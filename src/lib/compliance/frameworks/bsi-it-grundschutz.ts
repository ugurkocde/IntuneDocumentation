...
export const BSI_IT_GRUNDSCHUTZ: FrameworkDefinition = {
  ...
  mappings: {
    ...
    "windows-office-macro-antivirus": ["OPS.1.1.4", "SYS.2.2.3.A5"],
    "windows-office-signed-macros": ["SYS.2.1"],
    "macos-office-macros-disabled": ["SYS.2.1"],
    "windows-office-macro-settings-managed": ["SYS.2.1"],
    "windows-ie-disabled": ["SYS.2.1"],
    "windows-browser-java-blocked": ["SYS.2.1"],
    "windows-browser-intrusive-ads-blocked": ["SYS.2.1"],
    "macos-browser-intrusive-ads-blocked": ["SYS.2.1"],
    "windows-browser-security-settings-managed": ["SYS.2.1"],
    "tenant-mfa-all-apps": [],
