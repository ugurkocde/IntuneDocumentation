...
export const CYBER_ESSENTIALS: FrameworkDefinition = {
  ...
  mappings: {
    ...
    "windows-office-macro-antivirus": ["Malware protection"],
    "windows-office-signed-macros": ["Secure configuration"],
    "macos-office-macros-disabled": ["Secure configuration"],
    "windows-office-macro-settings-managed": ["Secure configuration"],
    "windows-ie-disabled": ["Secure configuration"],
    "windows-browser-java-blocked": ["Secure configuration"],
    "windows-browser-intrusive-ads-blocked": ["Secure configuration"],
    "macos-browser-intrusive-ads-blocked": ["Secure configuration"],
    "windows-browser-security-settings-managed": ["Secure configuration"],
    "tenant-mfa-all-apps": ["User access control"],
    "tenant-phishing-resistant-mfa": ["User access control"],
