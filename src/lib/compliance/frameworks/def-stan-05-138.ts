...
export const DEF_STAN_05_138: FrameworkDefinition = {
  ...
  mappings: {
    ...
    "windows-office-macro-antivirus": ["2426"],
    "windows-office-signed-macros": ["2418"],
    "macos-office-macros-disabled": ["2418"],
    "windows-office-macro-settings-managed": ["2418"],
    "windows-ie-disabled": ["2418"],
    "windows-browser-java-blocked": ["2418"],
    "windows-browser-intrusive-ads-blocked": ["2418"],
    "macos-browser-intrusive-ads-blocked": ["2418"],
    "windows-browser-security-settings-managed": ["2418"],
    "tenant-mfa-all-apps": [],
