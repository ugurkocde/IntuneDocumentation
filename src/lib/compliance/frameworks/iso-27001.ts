...
export const ISO_27001: FrameworkDefinition = {
  ...
  mappings: {
    ...
    "windows-office-macro-antivirus": ["8.7"],
    "windows-office-signed-macros": ["8.9"],
    "macos-office-macros-disabled": ["8.9"],
    "windows-office-macro-settings-managed": ["8.9"],
    "windows-ie-disabled": ["8.9"],
    "windows-browser-java-blocked": ["8.9"],
    "windows-browser-intrusive-ads-blocked": ["8.9"],
    "macos-browser-intrusive-ads-blocked": ["8.9"],
    "windows-browser-security-settings-managed": ["8.9"],
    "tenant-mfa-all-apps": ["8.5"],
    "tenant-phishing-resistant-mfa": ["8.5"],
