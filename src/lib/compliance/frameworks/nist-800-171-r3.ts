...
export const NIST_800_171_R3: FrameworkDefinition = {
  ...
  mappings: {
    ...
    "windows-office-macro-antivirus": ["03.14.02"],
    "windows-office-signed-macros": ["03.04.02", "03.04.06"],
    "macos-office-macros-disabled": ["03.04.02", "03.04.06"],
    "windows-office-macro-settings-managed": ["03.04.02", "03.04.06"],
    "windows-ie-disabled": ["03.04.02", "03.04.06"],
    "windows-browser-java-blocked": ["03.04.02", "03.04.06"],
    "windows-browser-intrusive-ads-blocked": ["03.04.02", "03.04.06"],
    "macos-browser-intrusive-ads-blocked": ["03.04.02", "03.04.06"],
    "windows-browser-security-settings-managed": ["03.04.02", "03.04.06"],
    "tenant-mfa-all-apps": ["03.05.03"],
    "tenant-phishing-resistant-mfa": ["03.05.03"],
