...
export const NIST_800_171: FrameworkDefinition = {
  ...
  mappings: {
    "windows-lsa-protection": ["3.4.2"],
    "windows-remote-credential-guard": ["3.4.2"],
    "windows-laps-management": ["3.5.2"],
    "windows-process-creation-logging": [],
    "windows-powershell-module-logging": [],

    "windows-applocker-rule-collections": ["3.4.9"],
    "windows-office-v3-signatures": [],
    "windows-office-macros-disabled": ["3.4.2", "3.4.6"],
    "windows-office-internet-macros-blocked": ["3.4.2", "3.4.6"],
    "windows-office-macro-antivirus": ["3.14.2", "3.14.5"],
    "windows-office-signed-macros": ["3.4.2", "3.4.6"],
    "macos-office-macros-disabled": ["3.4.2", "3.4.6"],
    "windows-office-macro-settings-managed": ["3.4.2", "3.4.6"],
    "windows-ie-disabled": ["3.4.2", "3.4.6"],
    "windows-browser-java-blocked": ["3.4.2", "3.4.6"],
    "windows-browser-intrusive-ads-blocked": ["3.4.2", "3.4.6"],
    "macos-browser-intrusive-ads-blocked": ["3.4.2", "3.4.6"],
    "windows-browser-security-settings-managed": ["3.4.2", "3.4.6"],
    "tenant-mfa-all-apps": ["3.5.3"],
    "tenant-phishing-resistant-mfa": ["3.5.3"],
