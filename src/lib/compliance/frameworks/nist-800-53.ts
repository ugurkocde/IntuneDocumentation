...
export const NIST_800_53: FrameworkDefinition = {
  ...
  mappings: {
    ...
    "windows-office-macro-antivirus": ["SI-3"],
    "windows-office-signed-macros": ["CM-6", "CM-7"],
    "macos-office-macros-disabled": ["CM-6", "CM-7"],
    "windows-office-macro-settings-managed": ["CM-6", "CM-7"],
    "windows-ie-disabled": ["CM-6", "CM-7"],
    "windows-browser-java-blocked": ["CM-6", "CM-7"],
    "windows-browser-intrusive-ads-blocked": ["CM-6", "CM-7"],
    "macos-browser-intrusive-ads-blocked": ["CM-6", "CM-7"],
    "windows-browser-security-settings-managed": ["CM-6", "CM-7"],
    "tenant-mfa-all-apps": [],
