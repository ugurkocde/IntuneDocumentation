...
export const NIST_CSF: FrameworkDefinition = {
  ...
  mappings: {
    ...
    "windows-office-macro-antivirus": ["DE.CM-09"],
    "windows-office-signed-macros": ["PR.PS-01"],
    "macos-office-macros-disabled": ["PR.PS-01"],
    "windows-office-macro-settings-managed": ["PR.PS-01"],
    "windows-ie-disabled": ["PR.PS-01"],
    "windows-browser-java-blocked": ["PR.PS-01"],
    "windows-browser-intrusive-ads-blocked": ["PR.PS-01"],
    "macos-browser-intrusive-ads-blocked": ["PR.PS-01"],
    "windows-browser-security-settings-managed": ["PR.PS-01"],
    "tenant-mfa-all-apps": ["PR.AA-03"],
    "tenant-phishing-resistant-mfa": ["PR.AA-03"],
    "windows-powershell-scriptblock-logging": ["DE.CM-09"],
    "windows-powershell-transcription": ["DE.CM-09"],
