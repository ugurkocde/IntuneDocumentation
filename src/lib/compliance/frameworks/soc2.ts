...
export const SOC_2: FrameworkDefinition = {
  ...
  mappings: {
    ...
    "windows-office-macro-antivirus": ["CC6.8"],
    "windows-office-signed-macros": ["CC6.8"],
    "macos-office-macros-disabled": ["CC6.8"],
    "windows-office-macro-settings-managed": ["CC6.8"],
    "windows-ie-disabled": ["CC6.8"],
    "windows-browser-java-blocked": ["CC6.8"],
    "windows-browser-intrusive-ads-blocked": ["CC6.8"],
    "macos-browser-intrusive-ads-blocked": ["CC6.8"],
    "windows-browser-security-settings-managed": ["CC6.8"],
    "tenant-mfa-all-apps": ["CC6.1"],
    "tenant-phishing-resistant-mfa": ["CC6.1"],
